CREATE DATABASE  IF NOT EXISTS `rodeo_food` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `rodeo_food`;
-- MySQL dump 10.13  Distrib 8.0.31, for macos12 (x86_64)
--
-- Host: 127.0.0.1    Database: rodeo_food
-- ------------------------------------------------------
...
INSERT INTO `food_items` VALUES (1,'Onion Rings',6.00),(2,'Chips',7.00),(3,'Chicken Chipotle Burger',8.00),(4,'Chicken Garlic Burger',5.00),(5,'Signature Beef Burger',6.00),(6,'Mushroom Beef Burger',9.00),(7,'Chocolate Shake',4.00),(8,'Soft Drink',7.00);
...
-- Dump completed on 2023-11-12  1:18:20
...
CREATE TABLE `orders` (
  ...
  CONSTRAINT `fk_orders_item` FOREIGN KEY (`item_id`) REFERENCES `food_items` (`item_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `orders` VALUES (40,1,2,12.00),(40,3,1,8.00),(41,4,3,15.00),(41,6,2,18.00),(42,2,1,7.00),(42,8,1,7.00),(43,2,1,7.00),(44,2,1,7.00),(45,8,1,7.00);
...
INSERT INTO `order_tracking` VALUES (40,'delivered'),(41,'in transit'),(42,'In Transit'),(43,'In Transit'),(44,'In Transit'),(45,'In Transit');
...
--
-- Dumping events for database 'rodeo_food'
--

--
-- Dumping routines for database 'rodeo_food'
--
